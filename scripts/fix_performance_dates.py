...
elif base_infer in text:
    text = text.replace(base_infer, new_infer, 1)
...
print("Performance-date inference fixed: current-year hints take priority over weekday guessing")
